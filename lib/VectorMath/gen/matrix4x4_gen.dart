...
class mat4x4Gen {
  ...
  vec4 col2;
  vec4 col3;
  mat4x4Gen([Dynamic col0_, Dynamic col1_, Dynamic col2_, Dynamic col3_]) {
    col0 = new vec4();
    col1 = new vec4();
    col2 = new vec4();
    col3 = new vec4();
    ...
    col2[2] = 1.0;
    col3[3] = 1.0;
    if (col0_ is vec4 && col1_ is vec4 && col2_ is vec4 && col3_ is vec4) {
      col0 = col0_;
      col1 = col1_;
      col2 = col2_;
      col3 = col3_;
