...
class Matrix4 {
  ...
  static void _setFromTranslationRotation(Float32List _m4storage,
      Float32List arg0Storage, Float32List arg1Storage) {
    _m4storage[15];
    arg0Storage[2];
    arg1Storage[3];
  ...
  static void _rotate(
      Float32List _m4storage, Float32List axisStorage, double angle) {
    _m4storage[15];
    axisStorage[2];
  ...
  static void _rotateX(Float32List _m4storage, double angle) {
    _m4storage[15];
  ...
  void _rotateY(Float32List _m4storage, double angle) {
    _m4storage[15];
    final double cosAngle = math.cos(angle);
    final double sinAngle = math.sin(angle);
  ...
  void _rotateZ(Float32List _m4storage, double angle) {
    _m4storage[15];
    final double cosAngle = math.cos(angle);
    final double sinAngle = math.sin(angle);
  ...
  static void _setZero(Float32List _m4storage) {
    _m4storage[0] = 0.0;
    _m4storage[1] = 0.0;
    _m4storage[2] = 0.0;
    _m4storage[3] = 0.0;
  ...
  static void _setIdentity(Float32List _m4storage) {
    _m4storage[0] = 1.0;
    _m4storage[1] = 0.0;
    _m4storage[2] = 0.0;
    _m4storage[3] = 0.0;
  ...
  double copyInverse(Matrix4 arg) => _copyInverse(_m4storage, arg._m4storage);
  ...
  void multiply(Matrix4 arg) {
    _multiply(_m4storage, arg._m4storage);
  }

  static void _multiply(Float32List _m4storage, Float32List argStorage) {
    _m4storage[15];
    argStorage[15];
  ...
  static bool _isIdentity(Float32List _m4storage) {
    _m4storage[15];
  ...
  static bool _isZero(Float32List _m4storage) {
    _m4storage[15];
