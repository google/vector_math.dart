...
class Matrix4 {
  ...
  static void _setFrom(Float64List _m4storage, Float64List argStorage) {
  ...
  static void _transpose(Float64List _m4storage) {
    _m4storage[15];
    double temp;
    temp = _m4storage[4];
  ...
  static double _determinant(Float64List _m4storage) {
    _m4storage[15];
  ...
  static double _copyInverse(Float64List _m4storage, Float64List argStorage) {
    _m4storage[15];
    argStorage[15];
  ...
  static void _scaleAdjoint(Float64List _m4storage, double scale) {
    _m4storage[15];
  ...
  static void _multiply(Float64List _m4storage, Float64List argStorage) {
    _m4storage[15];
    argStorage[15];
  ...
  static void _transposeMultiply(
      Float64List _m4storage, Float64List argStorage) {
    _m4storage[15];
    argStorage[15];
    final double m00 = _m4storage[0];
  ...
  void _multiplyTranspose(Float64List _m4storage, Float64List argStorage) {
    _m4storage[15];
    argStorage[15];
    final double m00 = _m4storage[0];
    final double m01 = _m4storage[4];
  ...
  static void _rotate3(Float64List _m4storage, Float64List argStorage) {
    _m4storage[15];
    argStorage[2];
