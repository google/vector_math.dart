...
class Vector3 implements Vector {
  ...
  static void _setValues(Float64List _v3storage, double x, double y, double z) {
    _v3storage[0] = x;
    _v3storage[1] = y;
    _v3storage[2] = z;
  }
  ...
  static double _length2(Float64List _v3storage) {
    double sum;
  ...
  static double _distanceToSquared(
      Float64List _v3storage, Float64List argStorage) {
    _v3storage[2];
    argStorage[2];
  ...
  static void _addScaled(
      Float64List _v3storage, Float64List argStorage, double factor) {
    _v3storage[2];
    argStorage[2];
