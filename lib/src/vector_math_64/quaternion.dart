...
class Quaternion {
  ...
  static void _setFrom(Float64List _qStorage, Float64List sourceStorage) {
    _qStorage[3];
    sourceStorage[3];
  ...
  static void _setValues(
      Float64List _qStorage, double x, double y, double z, double w) {
    _qStorage[3];
    _qStorage[0] = x;
    _qStorage[1] = y;
    _qStorage[2] = z;
  ...
  static void _setFromRotation(
      Float64List _qStorage, Float64List rotationMatrixStorage) {
  ...
  static double _normalize(Float64List _qStorage) {
  ...
  static double _length2(Float64List _qStorage) {
    _qStorage[3];
  ...
  static double _length(Float64List _qStorage) =>
