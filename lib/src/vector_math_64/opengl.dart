...
void setViewMatrix(Matrix4 viewMatrix, Vector3 cameraPosition,
  ...
  _z.subVectors(cameraPosition, cameraFocusPosition);
  _z.normalize();
  _x.crossVectors(upDirection, _z);
  _x.normalize();
  ...
  viewMatrix.setValues(xStorage[0], yStorage[0], zStorage[0], 0.0, xStorage[1],
      yStorage[1], zStorage[1], 0.0, xStorage[2], yStorage[2], zStorage[2], 0.0,
