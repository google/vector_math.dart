...
$$.HashMapImplementation = {"":
 ...
 remove$1: function(key) {
  ...
  if ($.geB(index, 0)) {
    ...
    $.indexSet(this._keys, index, $.CTC197);
 ...
 _probeForAdding$1: function(key) {
  ...
  for (var numberOfProbes = 1, insertionIndex = -1; true;) {
    ...
    if (existingKey == null) {
      ...
      return hash;
    else if (insertionIndex < 0 && $.CTC197 === existingKey)
      insertionIndex = hash;
    var numberOfProbes0 = numberOfProbes + 1;
    hash = $.HashMapImplementation__nextProbe(hash, numberOfProbes, $.get$length(this._keys));
    if (hash !== (hash | 0))
          ...
          switch (state) {
            ...
            case 2:
              ...
              if (existingKey == null) {
                ...
                return hash;
              else if ($.ltB(insertionIndex, 0) && $.CTC197 === existingKey)
                insertionIndex = hash;
              var numberOfProbes0 = numberOfProbes + 1;
              hash = $.HashMapImplementation__nextProbe(hash, numberOfProbes, $.get$length(this._keys));
            case 3:
...
$$.HashSetIterator = {"":
 ...
 hasNext$0$bailout: function(state, t1, t2) {
  if ($.geB(t1, $.get$length(t2)))
    return false;
  if ($.index(t2, this._nextValidIndex) === $.CTC197)
    this._advance$0();
...
$$.ConstantMap = {"":
 ...
 _throwImmutable$0: function() {
  throw $.captureStackTrace($.CTC201);
},
 toString$0: function() {
  return $.Maps_mapToString(this);
},
...
$$.FilteredElementList = {"":
 ...
 sort$1: function(compare) {
  throw $.captureStackTrace($.CTC198);
},
 addLast$1: function(value) {
  this.add$1(value);
},
...
$$.AbstractScanner = {"":
 ...
 tokenizeIdentifier$3: function(next, start, allowDollar) {
  ...
  for (var isAscii = true; true;) {
    ...
    if (t1)
      ...
      if ($.ltB(next, 128)) {
        if (isAscii)
          this.appendByteStringToken$2($.CTC144, this.asciiString$2(start, 0));
        else
          this.appendByteStringToken$2($.CTC144, this.utf8String$2(start, -1));
        return next;
      } else {
 ...
 tokenizeFractionPart$2: function(next, start) {
  ...
  if (!hasDigit) {
    ...
    if (46 === next)
      return this.select$3(46, $.CTC35, $.CTC37);
 ...
 tokenizeLessThan$1: function(next) {
  ...
  if (61 === next) {
    ...
    return this.select$3(61, $.CTC138, $.CTC140);
  else {
 ...
 tokenizeEquals$1: function(next) {
  ...
  next = this.advance$0();
  if (next === 61)
    return this.select$3(61, $.CTC116, $.CTC118);
  else if (next === 62) {
 ...
 tokenizeExclamation$1: function(next) {
  next = this.advance$0();
  if (next === 61)
    return this.select$3(61, $.CTC110, $.CTC112);
 ...
 tokenizeOpenSquareBracket$1: function(next) {
  ...
  if (next === 93) {
    ...
    if (typeof token === 'object' && token !== null && !!token.is$KeywordToken && $.eqB(token.value, $.CTC66))
      return this.select$3(61, $.CTC68, $.CTC70);
  }
 ...
 tokenizeTilde$1: function(next) {
  next = this.advance$0();
  if (next === 47)
    return this.select$3(61, $.CTC59, $.CTC61);
  else {
 ...
 bigSwitch$1: function(next) {
  ...
  if (next === 41)
    return this.appendEndGroup$3($.CTC15, ')', 40);
  if (next === 44) {
  ...
  if (next === 93)
    return this.appendEndGroup$3($.CTC25, ']', 91);
  if (next === 96) {
  ...
  if (next === 64)
    return this.tokenizeRawString$1(next);
  if (next === 34 || next === 39)
...
$$.StringScanner = {"":
 ["string", "groupingStack", "extraCharOffset", "includeComments", "byteOffset", "tokenStart", "tail", "tokens"],
 ...
 utf8String$2: function(start, offset) {
  if (typeof offset !== 'number')
    return this.utf8String$2$bailout(1, start, offset, 0, 0);
  var t1 = this.string;
  var t2 = this.byteOffset;
  if (typeof t2 !== 'number')
    return this.utf8String$2$bailout(2, start, t2, offset, t1);
...
$$.BeginGroupToken = {"":
 ["endGroup!", "value", "next", "charOffset", "info"],
 super: "StringToken"
};
...
$.dynamicFunction = function(name$) {
  ...
  if (!(f == null) && !!f.methods)
    return f.methods;
  var methods = {};
  var dartMethod = Object.getPrototypeOf($.CTC203)[name$];
  if (!(dartMethod == null))
...
$._looksLikePublicType = function(name$) {
  return $.geB($.get$length(name$), 2) && $.isUpper($.index(name$, 0)) && $.isLower($.index(name$, 1));
};
...
$.getFunctionForTypeNameOf = function() {
  ...
  if ($.contains$1(userAgent, $.CTC202) === true)
    return $.typeNameInChrome;
...
$.StringScanner$ = function(string, includeComments) {
  var t1 = new $.StringScanner(string, $.CTC199, 0, includeComments, -1, -1, null, $.Token$($.CTC9, -1));
...
$.Keyword_computeKeywordMap = function() {
  var result = $.LinkedHashMapImplementation$();
  for (var t1 = $.iterator($.CTC195); t1.hasNext$0() === true;) {
    var t2 = t1.next$0();
...
$.KeywordState_computeKeywordStateTable = function(start, strings, offset, length$) {
  ...
  for (var t1 = offset + length$, t2 = start + 1, i = offset, isLeaf = false, chunk = 0, chunkStart = -1; i < t1; ++i) {
    ...
    if (typeof t4 !== 'number')
      return $.KeywordState_computeKeywordStateTable$bailout(1, start, strings, offset, i, t2, result, isLeaf, chunk, chunkStart, t4, t1);
    if (t4 === start)
      isLeaf = true;
    t3 = strings.length;
    if (i < 0 || i >= t3)
    ...
    if (typeof t4 !== 'number')
      return $.KeywordState_computeKeywordStateTable$bailout(2, start, strings, isLeaf, offset, i, t2, result, t4, chunk, chunkStart, t1);
    if (t4 > start) {
      t3 = strings.length;
      if (i < 0 || i >= t3)
        throw $.ioore(i);
...
$._looksLikePrivateType = function(name$) {
  return $.geB($.get$length(name$), 3) && $.eqB($.index(name$, 0), '_') && $.isUpper($.index(name$, 1)) && $.isLower($.index(name$, 2));
};
...
$.CTC200 = new Isolate.$isolateProperties.ConstantMap(Isolate.$isolateProperties.CTC, {}, 0);
...
$.CTC197 = new Isolate.$isolateProperties._DeletedKeySentinel();
...
$.CTC203 = new Isolate.$isolateProperties.Object();
...
$.CTC201 = new Isolate.$isolateProperties.IllegalAccessException();
...
$.CTC196 = new Isolate.$isolateProperties.EmptyQueueException();
...
$.CTC193 = new Isolate.$isolateProperties.Keyword(Isolate.$isolateProperties.CTC65, true, 'static');
...
$.CTC191 = new Isolate.$isolateProperties.Keyword(Isolate.$isolateProperties.CTC65, true, 'set');
...
$.CTC199 = new Isolate.$isolateProperties.LinkTail();
...
$.CTC202 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, 'Chrome|DumpRenderTree');
...
$.CTC198 = new Isolate.$isolateProperties.UnsupportedOperationException('TODO(jacobr): should we impl?');
