...
void testAdjoint() {
  final input = new List<Matrix3>();
  final expectedOutput = new List<Matrix3>();
  ...
  input.add(new Matrix3.identity());
  expectedOutput.add(new Matrix3.identity());
...
void testSelfTransposeMultiply() {
  final inputA = new List<Matrix3>();
  final inputB = new List<Matrix3>();
  final expectedOutput = new List<Matrix3>();
...
void testSolving() {
  ...
  expect(backwards2.x, relativeEquals(b2.x));
  expect(backwards2.y, relativeEquals(b2.y));
}
...
void main() {
  group('Matrix3', () {
    ...
    test('2D transform', testTransform2);
    test('2D rotation', testAbsoluteRotate2);
    test('3D transform', testTransform);
    test('3D constructor', testConstructorCopy);
