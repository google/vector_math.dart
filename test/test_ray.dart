...
class RayTest extends BaseTest {
  ...
  void testRayAt() {
    final Ray parent =
        new Ray.originDirection(_v3(1.0, 1.0, 1.0), _v3(-1.0, 1.0, 1.0));
  ...
  void testRayIntersectionSphere() {
    final Ray parent =
        new Ray.originDirection(_v3(1.0, 1.0, 1.0), _v3(0.0, 1.0, 0.0));
  ...
  void testRayIntersectionTriangle() {
    ...
    final Triangle hitting = new Triangle.points(
        _v3(2.0, 2.0, 0.0), _v3(0.0, 4.0, -1.0), _v3(0.0, 4.0, 3.0));
    final Triangle cutting = new Triangle.points(
        _v3(0.0, 1.5, 1.0), _v3(2.0, 1.5, 1.0), _v3(1.0, 1.5, 3.0));
    final Triangle outside = new Triangle.points(
        _v3(2.0, 2.0, 0.0), _v3(2.0, 6.0, 0.0), _v3(2.0, 2.0, 3.0));
    final Triangle behind = new Triangle.points(
        _v3(0.0, 0.0, 0.0), _v3(0.0, 3.0, 0.0), _v3(0.0, 3.0, 4.0));
  ...
  void testRayIntersectionAabb3() {
    final Ray parent =
        new Ray.originDirection(_v3(1.0, 1.0, 1.0), _v3(0.0, 1.0, 0.0));
    final Aabb3 hitting =
        new Aabb3.minMax(_v3(0.5, 3.5, -10.0), _v3(2.5, 5.5, 10.0));
    final Aabb3 cutting =
        new Aabb3.minMax(_v3(0.0, 2.0, 1.0), _v3(2.0, 3.0, 2.0));
    final Aabb3 outside =
        new Aabb3.minMax(_v3(2.0, 0.0, 0.0), _v3(6.0, 6.0, 6.0));
    final Aabb3 behind =
        new Aabb3.minMax(_v3(0.0, -2.0, 0.0), _v3(2.0, 0.0, 2.0));
    final Aabb3 inside =
        new Aabb3.minMax(_v3(0.0, 0.0, 0.0), _v3(2.0, 2.0, 2.0));
