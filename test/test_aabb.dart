...
class AabbTest extends BaseTest {
  ...
  void testAabb3Center() {
    final Aabb3 aabb =
        new Aabb3.minMax(_v3(1.0, 2.0, 4.0), _v3(8.0, 16.0, 32.0));
  ...
  void testAabb3ContainsAabb3() {
    final Aabb3 parent =
        new Aabb3.minMax(_v3(1.0, 1.0, 1.0), _v3(8.0, 8.0, 8.0));
    final Aabb3 child =
        new Aabb3.minMax(_v3(2.0, 2.0, 2.0), _v3(7.0, 7.0, 7.0));
    final Aabb3 cutting =
        new Aabb3.minMax(_v3(0.0, 0.0, 0.0), _v3(5.0, 5.0, 5.0));
    final Aabb3 outside =
        new Aabb3.minMax(_v3(10.0, 10.0, 10.0), _v3(20.0, 20.0, 20.0));
    final Aabb3 grandParent =
        new Aabb3.minMax(_v3(0.0, 0.0, 0.0), _v3(10.0, 10.0, 10.0));
  ...
  void testAabb3ContainsSphere() {
    ...
    final Sphere outside =
        new Sphere.centerRadius(_v3(-10.0, -10.0, -10.0), 5.0);
  ...
  void testAabb3ContainsTriangle() {
    ...
    final Triangle child = new Triangle.points(
        _v3(2.0, 2.0, 2.0), _v3(3.0, 3.0, 3.0), _v3(4.0, 4.0, 4.0));
    final Triangle edge = new Triangle.points(
        _v3(1.0, 1.0, 1.0), _v3(3.0, 3.0, 3.0), _v3(4.0, 4.0, 4.0));
    final Triangle cutting = new Triangle.points(
        _v3(2.0, 2.0, 2.0), _v3(3.0, 3.0, 3.0), _v3(14.0, 14.0, 14.0));
    final Triangle outside = new Triangle.points(
        _v3(0.0, 0.0, 0.0), _v3(-3.0, -3.0, -3.0), _v3(-4.0, -4.0, -4.0));
  ...
  void testAabb3IntersectionAabb3() {
    ...
    final Aabb3 cutting =
        new Aabb3.minMax(_v3(0.0, 0.0, 0.0), _v3(5.0, 5.0, 5.0));
    final Aabb3 outside =
        new Aabb3.minMax(_v3(10.0, 10.0, 10.0), _v3(20.0, 20.0, 10.0));
    final Aabb3 grandParent =
        new Aabb3.minMax(_v3(0.0, 0.0, 0.0), _v3(10.0, 10.0, 10.0));

    final Aabb3 siblingOne =
        new Aabb3.minMax(_v3(0.0, 0.0, 0.0), _v3(3.0, 3.0, 3.0));
    final Aabb3 siblingTwo =
        new Aabb3.minMax(_v3(3.0, 0.0, 0.0), _v3(6.0, 3.0, 3.0));
    final Aabb3 siblingThree =
        new Aabb3.minMax(_v3(3.0, 3.0, 3.0), _v3(6.0, 6.0, 6.0));
