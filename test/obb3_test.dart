...
void testCorners() {
  ...
  absoluteTest(corner, new Vector3(-5.0, -5.0, -5.0));
...
void testTranslate() {
  ...
  a.copyCorner(0, corner);
  absoluteTest(corner, new Vector3(-5.0 - 1.0, -5.0 + 2.0, -5.0 + 3.0));
...
void testRotate() {
  ...
  a.copyCorner(0, corner);
  absoluteTest(corner, new Vector3(0.0, -5.0, -7.071067810058594));

  a.copyCorner(1, corner);
  absoluteTest(corner, new Vector3(-7.071067810058594, -5.0, 0.0));
...
void testTransform() {
  ...
  a.copyCorner(0, corner);
  absoluteTest(corner, new Vector3(-15.0, -15.0, -15.0));
...
void testClosestPointTo() {
  ...
  absoluteTest(closestPoint, new Vector3(2.0, 2.0, 2.0));
...
void testIntersectionTriangle() {
  ...
  final Triangle parallel0 = new Triangle.points(
      $v3(1.0, 0.0, 1.0), $v3(1.0, 10.0, 1.0), $v3(1.0, 0.0, 10.0));
  final Triangle parallel1 = new Triangle.points(
      $v3(1.0, 4.5, 0.0), $v3(1.0, -1.0, 9.0), $v3(1.0, 10.0, 9.0));
  final Triangle parallel2 = new Triangle.points(
  ...
  final Obb3 obb = new Obb3.centerExtentsAxes(
      $v3(21.0, -36.400001525878906, 2.799999952316284),
      $v3(0.25, 0.15000000596046448, 0.25), $v3(0.0, 1.0, 0.0),
  ...
  final Obb3 obb2 = new Obb3.centerExtentsAxes(
      ...
      $v3(-0.7071067690849304, -0.7071067690849304, 0.0), $v3(0.0, 0.0, 1.0));
  final Triangle triangle2 = new Triangle.points(
      $v3(25.5, -36.5, 2.5), $v3(25.5, -35.5, 3.5), $v3(24.5, -36.5, 2.5));
  final Triangle triangle2_1 = new Triangle.points($v3(24.5, -36.5, 2.5),
  ...
  final Obb3 obb3 = new Obb3.centerExtentsAxes(
      $v3(20.937196731567383, -37.599998474121094, 2.799999952316284),
      $v3(0.25, 0.15000000596046448, 0.25), $v3(0.0, -1.0, 0.0),
      $v3(1.0, 0.0, 0.0), $v3(0.0, 0.0, 1.0));
  final Triangle triangle3 = new Triangle.points(
      $v3(20.5, -37.5, 3.5), $v3(20.5, -37.5, 2.5), $v3(21.5, -37.5, 2.5));
  final Triangle triangle3_1 = new Triangle.points($v3(21.5, -37.5, 2.5),
  ...
  final Obb3 obb4 = new Obb3.centerExtentsAxes(
      $v3(19.242143630981445, -39.20925521850586, 2.549999952316284),
      $v3(0.25, 0.15000000596046448, 0.25), $v3(0.0, 1.0, 0.0),
      $v3(-1.0, 0.0, 0.0), $v3(0.0, 0.0, 1.0));
  final Triangle triangle4 = new Triangle.points(
      $v3(18.5, -39.5, 2.5), $v3(19.5, -39.5, 2.5), $v3(19.5, -38.5, 2.5));
  final Triangle triangle4_1 = new Triangle.points($v3(19.5, -38.5, 2.5),
      $v3(19.5, -39.5, 2.5), $v3(18.5, -39.5, 2.5)); // reverse normal direction
  final Triangle triangle4_2 = new Triangle.points(
      $v3(18.5, -39.5, 2.5), $v3(19.5, -38.5, 2.5), $v3(18.5, -38.5, 2.5));
  final Triangle triangle4_3 = new Triangle.points($v3(18.5, -38.5, 2.5),
